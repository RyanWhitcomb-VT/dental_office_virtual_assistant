...
class DentalBot extends ActivityHandler {
    constructor(configuration, qnaOptions) {
        ...
        this.onMembersAdded(async (context, next) => {
            ...
            const welcomeText = 'Welcome to the dental assistant. You can ask questions or schedule appointments.';
...
module.exports.DentalBot = DentalBot;